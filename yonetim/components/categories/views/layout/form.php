	...
	$('#sectionID').change(function() {
			...
			sectionID = $(this).val();
	 		$.ajax({
		 	      type:'POST',
		 	      url:'index.php',
		 	      data:'no_template=1&component=categories&command=ajaxSectionGetCategories&sectionID='+sectionID+'&parent_ID='+parent_ID,
...
<div class="page_header">Kategori Yönetimi [Ekle/Güncelle]</div>
...
<input type="hidden" 	name="component" 	id="component" 	value="categories" />
